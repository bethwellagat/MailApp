...
function imap_ref_snz() { return imap_session_ref(); } // shared: lib/imap.php
function open_box_snz($folder = 'INBOX', $opts = 0) { return imap_open_box($folder, $opts); } // shared: lib/imap.php
